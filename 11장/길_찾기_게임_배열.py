...
def preorder(y, x, answer):
    ...
    if len(right) > 0:
        preorder(right, x[:idx], answer)

    if len(left) > 0:
        preorder(left, x[idx + 1:], answer)
...
def postorder(y, x, answer):
    ...
    if len(right) > 0:
        postorder(right, x[:idx], answer)

    if len(left) > 0:
        postorder(left, x[idx + 1:], answer)
...
def solution(nodeinfo):
    ...
    preorder(y, x, preorder_list)
    postorder(y, x, postorder_list)
